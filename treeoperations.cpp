...
//template<typename T>
//Node<T>* constructTreeUtils(T pre[], char preLN[], int *index, int n)
//{
//  int idx = *index;
//  if(idx == n)
//      return NULL;
//  Node<T> *temp = new Node<T>(pre[idx]);
//   (*index)++;

//  if(preLN[index] =='N')
//  {
//      temp->left = constructTreeUtils(pre, preLN, index, n);
//      temp->right = constructTreeUtils(pre, preLN, index, n);
//  }
...
//template<typename T>
//Node<T>* constructTree(T pre[], char preLN[], int n)
//{
//  int index =0;
//  return constructTreeUtils(pre, preLN, index, n);
//}
